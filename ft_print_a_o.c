...
/*   Updated: 2017/10/20 18:37:26 by vpetit           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		ft_p(t_p_inf *infos, t_a_lst *a_lst, t_f_id *f_id)
{
	...
	// printf("infos->first_c = %s | infos->nbr_pad_dgt = %d | a_lst->a.ll = %lld | infos->len_a = %d \n", infos->first_c, infos->nbr_pad_dgt, a_lst->a.ll, infos->len_a);
}
